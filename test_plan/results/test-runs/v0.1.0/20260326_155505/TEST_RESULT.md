...
| 24 | `test_journey_backtest.py` | `TestHomePage` | `test_home_start_simulation_link[chromium]` | ❌ | AssertionError: assert '/backtest' in 'http://localhost:3001/' |
...
| 46 | `test_journey_benchmark.py` | `TestBenchmarkLeaderboard` | `test_live_benchmark_button_navigates_to_leaderboard[chromium]` | ❌ | AssertionError: assert '/benchmark/models' in 'http://localhost:3001/benchmark' |
| 47 | `test_journey_error.py` | `TestPageAccessibility` | `test_home_page_accessible[chromium]` | ❌ | playwright._impl._errors.TimeoutError: Timeout 30000ms exceeded. |
...
```
AssertionError: assert '/backtest' in 'http://localhost:3001/'
```
...
```
AssertionError: assert '/benchmark/models' in 'http://localhost:3001/benchmark'
```

### ❌ `test_journey_error.py::TestPageAccessibility::test_home_page_accessible[chromium]`
```
playwright._impl._errors.TimeoutError: Timeout 30000ms exceeded.
```
