...
| 파일 | ✅ | ❌ | ⏭️ |
|------|----|----|-----|
| `test_journey_backtest.py` | 17 | 7 | 0 |
| `test_journey_benchmark.py` | 14 | 8 | 0 |
| `test_journey_error.py` | 10 | 3 | 0 |
...
| 7 | `test_journey_backtest.py` | `TestBacktestStrategySelection` | `test_click_ema_trend[chromium]` | ❌ | playwright._impl._errors.TimeoutError: Locator.click: Timeout 30000ms exceeded. |
| 8 | `test_journey_backtest.py` | `TestBacktestStrategySelection` | `test_click_bb_squeeze[chromium]` | ❌ | playwright._impl._errors.TimeoutError: Locator.click: Timeout 30000ms exceeded. |
| 9 | `test_journey_backtest.py` | `TestBacktestStrategySelection` | `test_switch_strategy_back_to_rsi[chromium]` | ❌ | playwright._impl._errors.TimeoutError: Locator.click: Timeout 30000ms exceeded. |
| 10 | `test_journey_backtest.py` | `TestBacktestStrategySelection` | `test_strategy_description_updates[chromium]` | ❌ | playwright._impl._errors.TimeoutError: Locator.click: Timeout 30000ms exceeded. |
...
| 19 | `test_journey_backtest.py` | `TestBacktestRunButton` | `test_run_button_shows_loading_state[chromium]` | ❌ | playwright._impl._errors.TimeoutError: Locator.is_disabled: Timeout 30000ms exceeded. |
| 20 | `test_journey_backtest.py` | `TestHomePage` | `test_home_page_loads[chromium]` | ❌ | playwright._impl._errors.TimeoutError: Timeout 30000ms exceeded. |
...
| 24 | `test_journey_backtest.py` | `TestHomePage` | `test_home_start_simulation_link[chromium]` | ❌ | playwright._impl._errors.TimeoutError: Timeout 30000ms exceeded. |
...
| 28 | `test_journey_benchmark.py` | `TestBenchmarkOrderPage` | `test_add_order_button_present[chromium]` | ❌ | playwright._impl._errors.TimeoutError: Timeout 30000ms exceeded. |
...
| 32 | `test_journey_benchmark.py` | `TestBenchmarkOrderPage` | `test_no_error_on_load[chromium]` | ❌ | playwright._impl._errors.TimeoutError: Timeout 30000ms exceeded. |
...
| 39 | `test_journey_benchmark.py` | `TestBenchmarkOrderCard` | `test_confidence_button_clickable[chromium]` | ❌ | playwright._impl._errors.TimeoutError: Timeout 30000ms exceeded. |
...
| 46 | `test_journey_benchmark.py` | `TestBenchmarkLeaderboard` | `test_live_benchmark_button_navigates_to_leaderboard[chromium]` | ❌ | playwright._impl._errors.TimeoutError: Timeout 30000ms exceeded. |
...
### ❌ `test_journey_backtest.py::TestHomePage::test_home_page_loads[chromium]`
```
...
### ❌ `test_journey_benchmark.py::TestBenchmarkOrderPage::test_add_order_button_present[chromium]`
```
playwright._impl._errors.TimeoutError: Timeout 30000ms exceeded.
```

### ❌ `test_journey_benchmark.py::TestBenchmarkOrderPage::test_no_error_on_load[chromium]`
```
playwright._impl._errors.TimeoutError: Timeout 30000ms exceeded.
```

### ❌ `test_journey_benchmark.py::TestBenchmarkOrderCard::test_confidence_button_clickable[chromium]`
```
playwright._impl._errors.TimeoutError: Timeout 30000ms exceeded.
```
