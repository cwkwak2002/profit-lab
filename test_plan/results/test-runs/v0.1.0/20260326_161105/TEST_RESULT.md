...
| `test_journey_benchmark.py` | 22 | 0 | 0 |
| `test_journey_error.py` | 13 | 0 | 0 |
...
| 43 | `test_journey_benchmark.py` | `TestBenchmarkLeaderboard` | `test_leaderboard_renders_content[chromium]` | ✅ |  |
| 44 | `test_journey_benchmark.py` | `TestBenchmarkLeaderboard` | `test_leaderboard_no_500_error[chromium]` | ✅ |  |
| 45 | `test_journey_benchmark.py` | `TestBenchmarkLeaderboard` | `test_leaderboard_has_rankings_when_models_exist[chromium]` | ✅ |  |
...
| 57 | `test_journey_error.py` | `TestUXQuality` | `test_benchmark_submit_button_disabled_while_loading[chromium]` | ✅ |  |
